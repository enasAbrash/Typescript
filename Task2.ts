 class Contact {
  ...
  class AddressBook {
    ...
    findContactByName (name:string):Array<Contact> |any  {
      return this.contacts.find((contact:Contact) => contact.name === name);
   
    }
  
    filterByGroup (group:string):Array<Contact>{
    ...
    searchContacts(searchTerm:string):Array<Contact>{
  ...
  console.log(addressBook.printContacts());
